...
def find_color1(frame):
    ...
    hsv_lowerbound = np.array([0, 229, 196])  # replace THIS LINE w/ your hsv lowerb
    hsv_upperbound = np.array([10, 255, 255])  # replace THIS LINE w/ your hsv upperb
    ...
    if len(cnts) > 0:
        ...
        if M['m00'] > 0 and cv2.contourArea(maxcontour) > 50:
            ...
            return (100000, 100000), False  # faraway point
    else:
        return (100000, 100000), False  # faraway point
...
def find_color2(frame):
    ...
    if len(cnts) > 0:
        ...
        if M['m00'] > 0 and cv2.contourArea(maxcontour) > 50:
            ...
            return (100000, 100000), True  # faraway point
    else:
        return (100000, 100000), True  # faraway point
...
while (1):
    ...
    cv2.circle(copy_frame, (color2_x, color2_y), 5, (0, 128, 255), -1)
